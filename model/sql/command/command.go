...
var (
	...
	// VarStringType describes the type.
	VarStringType string
	// VarStringName describes the make file name.
...
func fromDDL(arg ddlArg) error {
	...
	for _, file := range files {
		err = generator.StartFromDDL(file, arg.cache, arg.strict, arg.database, arg.typ, arg.name)
		if err != nil {
			return err
		}
	}
